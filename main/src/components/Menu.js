         ...
         {user && <div className="flex justify-center text-white items-center gap-x-3 transition-all duration-1000">
          ...
          <div className=" ">
            <p  className="mt-[3rem] text-white">MENU</p>
              ...
              <li>
              <NavLink to="/gallery" href="#" className="block py-2 px-3 text-white bg-blue-600 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Gallery</NavLink>
              </li>
              <li>
