...
const   Confirmation = ({ user, cartItem, cartBuy ,setBuyPage, setCartBuy}) => {
  ...
  return (
    <div className="relative ">
      ...
      <div className="bg-white overflow-y-scroll no-scrollbar p-3  rounded-md min-w-[280px] w-[40vw] h-[55vh] relative">
        ...
        {currentStep === 1 && <PaymentInfo cartItem={cartItem} cartBuy={cartBuy} setCartBuy={setCartBuy} />}
        {currentStep === 2 && <Finish cartItem={cartItem} user={user} formData={formData} cartBuy={cartBuy} setCartBuy={setCartBuy}/>}
        <StepperControl
